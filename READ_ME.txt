...
patterns, customer segments, product preferences, and subscription behavior.
...
* Column Standardization: Renamed columns to snake case for better readability and
  documentation
*  Feature Engineering:
    a. Created age_group column by binning customer ages.
    b. Created purchase_frequency_days column from purchase data.
